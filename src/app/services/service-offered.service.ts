...
export class ServiceOfferedService {
  ...
  getServices(): ServiceOffered{
    this.data = [
      ...
      {title:'Desktop Development',description:'Rarely used but can be of great applications for companies or individuals. Whatever requirements you have, a desktop software is a piece of cake.',more:''}
    ];
